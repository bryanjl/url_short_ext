...
import * as am4core from './amCharts/core.mjs';
import * as am4maps from './amCharts/maps.mjs';
import * as am4charts from './amCharts/charts.mjs';
import * as am4themes_animated from './amCharts/animated.mjs';

// console.log(am4core);

function loadAnalyticsPage(linkID) {
  let token;
  ...
  .then(json => {
    // console.log(json.data.country_code);
    amChartMap(json.data.country_code);

    let myJSON = json.data.country_code;
...
function amChartMap(myJSON) {
  ...
  homeButton1.insertBefore(chart.zoomControl.plusButton);
}



export { loadAnalyticsPage };
